...
const AdminSidebar = () => {
  ...
  const displayName = user ? `${user.firstName} ${user.lastName}` : (userType.charAt(0).toUpperCase() + userType.slice(1));
  const badgeText = userType === 'staff' ? 'Staff' : 'Admin';
          ...
          <div className="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-green-50 to-white">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                ...
                <div className="mt-1">
                  <span className="inline-block bg-gradient-to-r from-green-100 to-green-200 text-green-800 text-xs px-3 py-1 rounded-full font-semibold border border-green-300">
                    {badgeText}
                  </span>
                </div>
              </div>
